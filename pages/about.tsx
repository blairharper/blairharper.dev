    ...
    <div className="max-w-6xl">
      <article className="prose dark:prose-invert">
        ...
        <p>
          ...
          lot of fun writing scripts in visual basic to post cool (to a
          10-year-old) macro-effects in AOL chat rooms. In my late teens I
          started learning PHP and JavaScript. I developed and launched an
          AdWords copycat pay-per-click advertising platform when I was 19. It
          didn't work out.
        </p>
        <p>
          ...
          JavaScript frameworks like React, React Native, Next. I also got very
          familiar with the popular PHP framework, Laravel.
        </p>
        <p>
          My experience in Civil Service made me pretty good at managing a lot
          ...
          I'm currently doing an MBA at Edinburgh Business School.
        </p>
        <p>
        ...
        <p>
          ...
          learned over the years that it's actually a superpower.
        </p>
      </article>
    </div>
  );
